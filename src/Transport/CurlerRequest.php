...
class CurlerRequest
{
     ...
     * @var array
     */
    private $headers; // Parsed response header object.
     ...
     */
    public function attachFiles(array $attachFiles)
    {
     ...
     * @return $this
     */
    public function setRequestExtendedInfo(array $params)
    {
     ...
     * @return bool|resource
     */
    public function setInfile(string $file_name)
    {
        $this->header('Expect', '');
     ...
     */
    public function setCallbackFunction(callable $callback)
    {
     ...
     * @param callable $callback
     */
    public function setWriteFunction(callable $callback)
    {
     ...
     * @param callable $callback
     */
    public function setReadFunction(callable $callback)
    {
     ...
     */
    public function setCallback(string $classCallBack, string $functionName)
    {
    ...
    public function parameters_json($data)
    {
        ...
        if (!$this->parameters && $data) {
            throw new TransportException('Cant json_encode: ' . strval($data));
        }
    ...
    {
        if (!$this->response) {
            throw new TransportException('Can`t fetch response - is empty');
        }
