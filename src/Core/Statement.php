...
use Luminee\CHouSun\Transport\CurlerRequest;
use Luminee\CHouSun\Transport\CurlerResponse;
use Luminee\CHouSun\Exception\QueryException;
use Luminee\CHouSun\Exception\DatabaseException;
use Luminee\CHouSun\Exception\TransportException;
use Luminee\CHouSun\Exception\ClickHouseUnavailableException;
...
class Statement
{
    ...
    public function output()
    {
        ...
        $std->time = $this->totalTimeRequest();
        $std->rows = $this->rows();
        return $std;
    }
     ...
     * @throws TransportException
     */
    public function rowsAsTree(string $path)
    {
        $this->init();
